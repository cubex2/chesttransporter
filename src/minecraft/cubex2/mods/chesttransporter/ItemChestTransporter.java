...
public class ItemChestTransporter extends Item
{
	...
	private EntityMinecart replaceMinecart(EntityMinecart old)
	{
		old.setDead();
		EntityMinecart newMinecart = new EntityMinecartEmpty(old.worldObj);
		newMinecart.setPosition(old.posX, old.posY, old.posZ);
		newMinecart.setAngles(old.rotationPitch, old.rotationYaw);
		old.worldObj.spawnEntityInWorld(newMinecart);
		return newMinecart;
	}
	...
	{
		Icon i1 = iconRegister.registerIcon("chesttransporter:0");
		Icon i2 = iconRegister.registerIcon("chesttransporter:0");
		icons = new Icon[10];
